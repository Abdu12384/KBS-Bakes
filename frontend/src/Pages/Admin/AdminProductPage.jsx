...
//    const matchesSearch = product.productName.toLowerCase().startsWith(searchQuery.toLowerCase())
//    const matchesFilter =
//     filterStatus === "All" ||
//     (filterStatus === "Active" && product.stock > 0 && !product.isDeleted) ||
//     (filterStatus === "Blocked" && (product.stock === 0 || product.isDeleted)) ||
//     (filterStatus === "Available" && (!product.isDeleted && product.stock>0 )) ||
//     (filterStatus === "Unavailable" && product.stock === 0);
